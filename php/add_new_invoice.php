<?php
  ...
  function updateStock($name, $batch_id, $quantity) {
    ...
    if($con) {
      ...
      $result = mysqli_query($con, $query);
      echo ($result) ? "stock mis a jour" : "echec";
    }
  }
  ...
  function addSale() {
    ...
    if($con) {
      ...
      $result = mysqli_query($con, $query);
      echo ($result) ? "vente enregistree" : "echec...";
    }
  }
  ...
  function addNewInvoice() {
    ...
    if($con) {
      ...
      $result = mysqli_query($con, $query);
      echo ($result) ? "Facture enregistree..." : "echec enregistrement facture...";
    }
  }
?>
