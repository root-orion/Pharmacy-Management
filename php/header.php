    ...
    <section class="row content-header">
      ...
      <div class="col-md-1 user_options">
        ...
        <ul id="options" class="options list-unstyled" style="display: none;">
          <li>
            <a href="my_profile.php"><i class="fa fa-user"></i><span>Mon Profil</span></a>
          </li>
          <li>
            <a href="change_password.php"><i class="fa fa-edit"></i><span>Changer de mot de passe</span></a>
          </li>
          <li>
            <a href="logout.php"><i class="fa fa-key"></i><span>Se deconnecter</span></a>
          </li>
        </ul>
      </div>
    </section>
