    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('bar-chart', 'Commande', 'Ajouter une nouvelle commande');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-4 form-group">
              <label class="font-weight-bold" for="suppliers_name">Founisseur :</label>
              <input id="suppliers_name" type="text" class="form-control" placeholder="" name="suppliers_name" onkeyup="showSuggestions(this.value, 'supplier');">
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="">Facture No :</label>
              <input type="number" class="form-control" placeholder="" id="invoice_number" name="invoice_number" onblur="notNull(this.value, 'invoice_number_error'); checkInvoice(this.value, 'invoice_number_error');">
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="paytype">Paiement par :</label>
              <select id="payment_type" name="paytype" class="form-control">
              	<option value="Cash Payment">Cash</option>
                <option value="Net Banking">Virement</option>
                <option value="Payment Due">Carte</option>
              </select>
            </div>
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              <button class="btn btn-primary form-control" onclick="addPurchase();">AJOUTER</button>
            </div>
            <div class="col col-md-5"></div>
          </div>
          <!-- closing button -->
