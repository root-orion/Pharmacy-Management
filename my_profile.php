    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('user', 'Profil', 'Modifier details du compte');
          // header section end
          ...
          <div class="row col col-md-6">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                <label class="font-weight-bold" for="pharmacy_name">Nom Pharmacie :</label>
                <input id="pharmacy_name" type="text" class="form-control" value="<?php echo $pharmacy_name; ?>" placeholder="Nom Pharmacie" onkeyup="validateName(this.value, 'pharmacy_name_error');" disabled>
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <textarea id="address" class="form-control" placeholder="adresse" onkeyup="validateAddress(this.value, 'address_error');" style="max-height: 100px;" disabled><?php echo $address; ?></textarea>
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="contact_number" type="number" class="form-control" value="<?php echo $contact_number; ?>" placeholder="contact" onkeyup="validateContactNumber(this.value, 'contact_number_error');" disabled>
            ...
            <div class="row col col-md-12 m-auto" id="edit">
              ...
              <div id="edit_button" class="col col-md-4 form-group float-right">
                <button class="btn btn-primary form-control font-weight-bold" onclick="edit();">EDITER</button>
              </div>
              <div id="password_button" class="col col-md-4 form-group float-right">
                <a href="change_password.php" class="btn btn-warning form-control font-weight-bold">Changer mot de passe</a>
              </div>
            </div>
            ...
            <div class="row col col-md-12 m-auto" id="update_cancel" style="display: none;">
              ...
              <div id="cancel_button" class="col col-md-4 form-group float-right">
                <button class="btn btn-danger form-control font-weight-bold" onclick="edit(true);">ANNULER</button>
              </div>
              <div id="update_button" class="col col-md-4 form-group float-right">
                <button class="btn btn-success form-control font-weight-bold" onclick="updateAdminDetails();">METTRE A JOUR</button>
              </div>
            </div>
            <!-- result message -->
