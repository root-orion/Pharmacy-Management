    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('address-book', 'Factures', 'Gerer les factures');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            <input type="number" class="form-control" id="by_invoice_number" placeholder="Par numero de facture" onkeyup="searchInvoice(this.value, 'INVOICE_ID');">
            &emsp;<input type="text" class="form-control" id="by_customer_name" placeholder="Par nom client" onkeyup="searchInvoice(this.value, 'NAME');">
