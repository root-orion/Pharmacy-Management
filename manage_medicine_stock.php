    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('shopping-bag', 'Medicament', 'Gerer les Stocks');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            &emsp;<button class="btn btn-danger font-weight-bold" onclick="searchMedicineStock('0', 'QUANTITY');">En rupture de Stock</button>
            &emsp;<button class="btn btn-warning font-weight-bold" onclick="searchMedicineStock('', 'EXPIRY_DATE');">Perimes</button>
            ...
            <div class="table-responsive">
            	<table class="table table-bordered table-striped table-hover">
            		<thead>
            			<tr>
            				<th style="width: 1%;">#</th>
            				<th style="width: 14%;">Nom Medicament </th>
                    <th style="width: 5%;">Packing</th>
                    <th style="width: 14%;">Nom Generique</th>
                    <th style="width: 10%;">Code</th>
                    <th style="width: 8%;">Date Exp.(mm/yy)</th>
            				<th style="width: 15%;">Fournisseur</th>
                    <th style="width: 7%;">Qte.</th>
                    <th style="width: 8%;">P.V.M.</th>
